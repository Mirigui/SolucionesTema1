...
```{r}
#La diferencia viene dada como ya he dicho anteriormente porque en como bien su nombre indica en el conjunto mammals todos loa animlaes son mamiferos y en cambio en el conjunto Animals2 tambien hay 3 reptiles(dinosaurios) por tanto no iban a esatr en el otro conjunto.
